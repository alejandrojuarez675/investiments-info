...
## Corpus Check
- 21 files · ~8,955 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 145 nodes · 152 edges · 30 communities (17 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `128ab9b8`
...
9. `Plazo fijo y dólar: las inversiones más populares en Argentina` - 6 edges
10. `Qué es el Merval` - 6 edges
...
## Knowledge Gaps
- **105 isolated node(s):** `graphify`, `Convención de archivos`, `Estructura`, `Para asistentes de IA`, `Idea central` (+100 more)
