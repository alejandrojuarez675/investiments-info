...
## Corpus Check
- 24 files · ~12,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 177 nodes · 176 edges · 31 communities (18 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `744507b3`
...
5. `Mercado Pago en Argentina: catálogo de productos` - 8 edges
6. `Bitcoin y Ethereum: conceptos básicos` - 7 edges
7. `ETFs que replican el S&P 500 y el Nasdaq-100` - 7 edges
...
Cohesion: 0.12
Nodes (12): Fuentes, Fórmula básica, Interés compuesto, Por qué importa el tiempo más que el monto, Regla del 72, Relación con otros conceptos, Características principales, Cómo invertir en el índice (+4 more)
...
Cohesion: 0.14
Nodes (12): Crédito y financiamiento, Fuentes, Mercado Pago en Argentina: catálogo de productos, Notas, Otros, Pagos y cobros, Rendimiento e inversión, Seguros (+4 more)
...
## Knowledge Gaps
- **131 isolated node(s):** `Convención de archivos`, `Estructura`, `Para asistentes de IA`, `Pagos y cobros`, `Rendimiento e inversión` (+126 more)
...
- **Should `Mercado Pago en Argentina: catálogo de productos` be split into smaller, more focused modules?**
