...
## Corpus Check
- 142 files · ~76,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1033 nodes · 1156 edges · 127 communities (122 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e0aa04b`
...
Cohesion: 0.22
Nodes (8): Acciones AR (`acciones_ar.csv`), ADRs (`adrs.csv`), acciones US (`acciones_us.csv`), CEDEARs (`cedears.csv`), ETFs (`etfs.csv`), Actualizar cotizaciones, APIs a usar por categoría, Bonos AR (`bonos_ar.csv`), Crypto (`crypto.csv`), Dólar ARS (`data/tasas/tasas.csv`, instrumentos `dolar_oficial`/`dolar_mep`/`dolar_ccl`/`dolar_blue`), Plazo fijo (`data/tasas/tasas.csv`, instrumentos `plazo_fijo`/`plazo_fijo_uva`), Procedimiento
...
### Community 112 - "Daily report"
Cohesion: 0.40
Nodes (4): Al finalizar, Antes de escribir, Daily report, Secciones del reporte

### Community 113 - "Daily report — jueves 23/07/2026"
Cohesion: 0.40
...
Cohesion: 0.33
Nodes (5): Al finalizar, Antes de buscar, Búsqueda de noticias, Get news report, Guardado en la base de datos

## Knowledge Gaps
- **712 isolated node(s):** `Antes de buscar`, `Búsqueda de noticias`, `Guardado en la base de datos`, `Al finalizar`, `Props` (+707 more)
...
- **Why does `Qué es el S&P 500` connect `Qué es el S&P 500` to `Activos y Glosario`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **What connects `Antes de buscar`, `Búsqueda de noticias`, `Guardado en la base de datos` to the rest of the system?**
