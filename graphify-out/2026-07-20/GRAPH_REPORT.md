...
## Summary
- 153 nodes · 162 edges · 31 communities (18 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1edefa44`
...
## Knowledge Gaps
- **111 isolated node(s):** `graphify`, `Convención de archivos`, `Estructura`, `Para asistentes de IA`, `Idea central` (+106 more)
